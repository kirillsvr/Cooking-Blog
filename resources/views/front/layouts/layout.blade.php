...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/front/css/css/icofont.min.css')}}">
...
<header class="header-section header-4 d-xl-block d-none">
    <div class="container">
        <div class="header-area">
            <div class="logo">
                <a href="index.html"><img src="/assets/front/images/logo/01.png" alt="logo"></a>
            </div>
            <div class="main-menu">
                <ul>
                    <li>
            ...
            <div class="author-option">
                <div class="author-area">
                    ...
                    <div class="cart-option">
                        <div class="cart-icon">
                            <img src="/assets/front/images/header/cart.png" alt="shop-cart">
                        </div>
                                ...
                                <div class="cart-con-item">
                                    <div class="cart-item">
                                        <div class="cart-inner">
                                            <div class="cart-top">
                                                <div class="thumb">
                                                    <a href="#"><img src="/assets/front/images/popular-food/01.jpg" alt=""></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="cart-item">
                                        <div class="cart-inner">
                                            <div class="cart-top">
                                                <div class="thumb">
                                                    <a href="#"><img src="/assets/front/images/popular-food/02.jpg" alt=""></a>
                                                </div>
                                                <div class="content">
                                                    <a href="#">Split Remedy Split End Shampoo</a>
                                                </div>
                                    ...
                                    <div class="cart-item">
                                        <div class="cart-inner">
                                            <div class="cart-top">
                                                <div class="thumb">
                                                    <a href="#"><img src="/assets/front/images/popular-food/03.jpg" alt=""></a>
                                                </div>
                                                <div class="content">
                                                    <a href="#">Split Remedy Split End Shampoo</a>
                                                </div>
                                    ...
                                    <div class="cart-item">
                                        <div class="cart-inner">
                                            <div class="cart-top">
                                                <div class="thumb">
                                                    <a href="#"><img src="/assets/front/images/popular-food/04.jpg" alt=""></a>
                                                </div>
                                                <div class="content">
                                                    <a href="#">Split Remedy Split End Shampoo</a>
                                                </div>
